...
class CodableFeedStoreTests: XCTestCase {
    ...
    func test_insert_overridesPreviouslyInsertedCacheValues() {
        ...
        XCTAssertNil(latestInsertionError, "expected to ovverride cache succesfully")
    ...
    func test_insert_deliversErrorOnInsertionError() {
        ...
        let firstInsertionError = insert((latestFeed, latestTimestamp), to: sut)
    ...
    func test_storeSideEffects_unSerially() {
        let sut = makeSUT()
        ...
        XCTAssertEqual(completedOperationsInOrder, [op1, op2, op3], "Expected side effect to run serially but operations finsished in wrong order")
    }
