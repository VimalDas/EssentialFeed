...
class EssentialFeedApiEndToEndTests: XCTestCase {
    ...
    func test_endToEndServerGETFeedResult_matchesFiexedTestAccountData() {
        ...
        case let .failure(error):
            XCTFail("Expected succesfull feed result, got \(error) instead")
            
        default:
            XCTFail("Expected succesfull feed result, got no instead")
        }
    }
